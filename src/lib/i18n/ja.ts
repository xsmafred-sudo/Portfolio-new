export const ja = {
  ...
  services: {
    ...
    fullstack: {
      title: 'フルスタック開発',
      description:
        'Java、Spring Boot、React、Next.js、TypeScriptを使用した安全でスケーラブルなアプリケーションの構築。',
    },
    cloud: {
      title: 'クラウド＆DevOps',
      description:
        'AWS、GCP、Docker、Vercelでのアプリケーションのデプロイと管理、CI/CDパイプラインの実装。',
    },
    api: {
      title: 'API開発',
      description:
    ...
    database: {
      title: 'データベース管理',
      description:
        'パフォーマンスとセキュリティの最適化によるPostgreSQL、MySQL、MongoDB、Supabaseの管理。',
    },
    security: {
      title: 'セキュリティ＆不正対策',
      description:
        'OWASP Top-10セキュリティプラクティス、SSL/TLS、ネットワーク強化、MLベース不正検知の実施。',
    },
    uiux: {
      title: 'UI/UX開発',
      description:
        'React、Angular、最新のデザイン原則を使用した直感的でレスポンシブなインターフェースの作成。',
    },
  },
  about: {
    title: '私について',
  ...
  contact: {
    title: 'お問い合わせ',
    subtitle:
      '現在、新しい機会を探しています。質問があるか、単に挨拶したい場合は、必ず返信します！',
    email: 'メール送信',
  },
  footer: {
    rights: '全著作権所有。',
